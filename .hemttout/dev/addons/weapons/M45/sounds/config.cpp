...
class cfgSoundShaders
{
	...
	class 22nd_M45_Closure_SoundShader: 22nd_Sniper_Closure_Soundshader
	{
		samples[]=
		{
			...
			{
				"\z\22ndRDF\addons\weapons\M45\sounds\M45_closure.wav",
				1
			}
		};
	...
	class 22nd_M45_closeShot_SoundShader
	{
		samples[]=
		{
			...
			{
				"\z\22ndRDF\addons\weapons\M45\sounds\M45_close.wav",
				1
			}
		};
		volume=1.3;
	...
	class 22nd_M45_midShot_SoundShader
	{
		samples[]=
		{
			...
			{
				"\z\22ndRDF\addons\weapons\M45\sounds\M45_distant.wav",
				1
			}
		};
		volume=1;
	...
	class 22nd_M45_distShot_SoundShader
	{
		samples[]=
		{
			...
			{
				"\z\22ndRDF\addons\weapons\M45\sounds\M45_far.wav",
				1
			}
		};
		volume=1;
