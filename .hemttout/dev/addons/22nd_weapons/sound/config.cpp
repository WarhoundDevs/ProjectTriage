...
class cfgSoundShaders 
{
	...
	{
		samples[] = {{"\addons\22nd_weapons\sound\Sounds\RifleTailIIndoor.wss",1}};
	...
	{
		samples[] = {{"\addons\22nd_weapons\sound\Sounds\RifleTailWoods.wss",1}};
	...
	{
		samples[] = {{"\addons\22nd_weapons\sound\Sounds\RifleOurdoors.wss",1}};
	...
	{
		samples[] = {{"\addons\22nd_weapons\sound\Sounds\RifleTailHouse.wss",1}};
