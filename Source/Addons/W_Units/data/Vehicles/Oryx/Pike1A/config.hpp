class 22nd_Oryx_Pike1A: Warhound_Oryx_Alpha //Will need to remove '_Alpha' and 'Alpha' once new aux mod release, currently there to avoid issues with main aux mod as they use the same class name. - Lex
{
	author="Kidd";
	displayName="[22nd] Pike 1-A M494 Oryx IFV";
	hiddenSelectionsTextures[] =
	{
		"W_Units\data\Vehicles\Oryx\Pike1A\Urban\22nd_pike1A_oryx_armor_urban_co.paa",
		"W_Units\data\Vehicles\Oryx\Pike1A\Urban\22nd_pike1A_oryx_main_urban_co.paa",
	...
	class textureSources
	{
		...
		class Oryx_Arid
		{
			...
			textures[] =
			{
				"W_Units\data\Vehicles\Oryx\Pike1A\Arid\22nd_pike1A_oryx_armor_arid_co.paa",
				"W_Units\data\Vehicles\Oryx\Pike1A\Arid\22nd_pike1A_oryx_main_arid_co.paa",
		...
		class Oryx_Woodland
		{
			...
			textures[] =
			{
				"W_Units\data\Vehicles\Oryx\Pike1A\Woodland\22nd_pike1A_oryx_armor_woodland_co.paa",
				"W_Units\data\Vehicles\Oryx\Pike1A\Woodland\22nd_pike1A_oryx_main_woodland_co.paa",
		...
		class Oryx_Arctic
		{
			...
			textures[] =
			{
				"W_Units\data\Vehicles\Oryx\Pike1A\Arctic\22nd_pike1A_oryx_armor_arctic_co.paa",
				"W_Units\data\Vehicles\Oryx\Pike1A\Arctic\22nd_pike1A_oryx_main_arctic_co.paa",
