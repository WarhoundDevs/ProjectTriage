...
class cfgSoundShaders 
{
	...
	{
		samples[] = {{"\z\22ndRDF\addons\weapons\MA37\Sounds\MA37_Closure.wss",1}}; 
		//volume = 0; //remove or adjust value after closure is added
	};
	class 22nd_MA37_closeShot_SoundShader
	{
		samples[] = {{"\z\22ndRDF\addons\weapons\MA37\Sounds\MA37_Close.wss",1}};
		volume=1;
		range=50;
		rangeCurve[] = {{0,1},{50,0}};
	};
	...
	{
		samples[] = {{"\z\22ndRDF\addons\weapons\MA37\Sounds\MA37_distant.wss",1}};
		volume=1;
		range = 3000;
	...
	{
		samples[] = {{"\z\22ndRDF\addons\weapons\MA37\Sounds\MA37_far.wss",1}};
		volume=1;
		range=4000;
