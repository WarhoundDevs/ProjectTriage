...
class cfgSoundShaders
{
	...
	class 22nd_M393_closure_SoundShader: 22nd_HMG_Closure_Soundshader
	{
		samples[]=
		{
			...
			{
				"\addons\22nd_weapons\M393EMR\sounds\M393_closure.wav",
				1
			}
		};
	...
	class 22nd_M393_closeShot_SoundShader
	{
		samples[]=
		{
			...
			{
				"\addons\22nd_weapons\M393EMR\sounds\M393_close.wav",
				1
			}
		};
		volume=4;
	...
	class 22nd_M393_midShot_SoundShader
	{
		samples[]=
		{
			...
			{
				"\addons\22nd_weapons\M393EMR\sounds\M393_distant.wav",
				1
			}
		};
		volume=1.4;
	...
	class 22nd_M393_distShot_SoundShader
	{
		samples[]=
		{
			...
			{
				"\addons\22nd_weapons\M393EMR\sounds\M393_far.wav",
				1
			}
		};
		volume=1.4;
