...
class cfgSoundShaders 
{
	...
	{
		samples[] = {{"\addons\22nd_weapons\MA37\Sounds\MA37_Closure.wav",1}}; 
		//volume = 0; //remove or adjust value after closure is added
	};
	class 22nd_MA37_closeShot_SoundShader
	{
		samples[] = {{"\addons\22nd_weapons\MA37\Sounds\MA37_Close.wav",1}};
		volume = 2;
		range = 110;
	...
	{
		samples[] = {{"\addons\22nd_weapons\MA37\Sounds\MA37_distant.wav",1}};
		volume = 1;
		range = 1800;
	...
	{
		samples[] = {{"\addons\22nd_weapons\MA37\Sounds\MA37_far.wav",1}};
		volume = 1.0;
		range = 6000;
	...
	{
		samples[] = {{"\addons\22nd_weapons\MA37\Sounds\MA37_S_close.wss",1}};
		volume = 1.5;
		range = 300;
	...
	{
		samples[] = {{"\addons\22nd_weapons\MA37\Sounds\MA37_S_distant.wss",1}};
		volume = 1;
		range = 1000;
