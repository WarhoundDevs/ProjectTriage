...
class cfgSoundShaders
{
	...
	class ValkHalo_M392_Closure_SoundShader: ValkHalo_DMR_Closure_Soundshader
	{
		samples[]=
		{
			...
			{
				"\addons\22nd_weapons\M392\sounds\M392_Closure.wav",
				1
			}
		};
	...
	class ValkHalo_M392_closeShot_SoundShader
	{
		samples[]=
		{
			...
			{
				"\addons\22nd_weapons\M392\sounds\M392_Close.wav",
				1
			}
		};
		volume=1;
	...
	class ValkHalo_M392_midShot_SoundShader
	{
		samples[]=
		{
			...
			{
				"\addons\22nd_weapons\M392\sounds\M392_Close.wss",
				1
			}
		};
		volume=0.79432821;
	...
	class ValkHalo_Suppressed_M392_closeShot_SoundShader
	{
		samples[]=
		{
			...
			{
				"\addons\22nd_weapons\M392\Sounds\M392_close_Suppressed.wss",
				1
			}
		};
		volume=1.5;
