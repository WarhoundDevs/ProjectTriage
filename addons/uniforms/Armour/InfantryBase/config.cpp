class CfgPatches 
{
    class 22nd_uniforms_armour_base
    {
        units[] = 
        {
            ...
            //BioHazard Armor
            // BH BDU LIGHT STANDARD SHOULDER
            "22nd_Base_Light_Gray_CBRN_Low_Std", // 1
            "22nd_Base_Light_Gray_CBRN_High_Std", // 2

            // BH BDU MEDIUM STANDARD SHOULDER
            "22nd_Base_Medium_Gray_CBRN_Low_Std",// 1
            "22nd_Base_Medium_Gray_CBRN_High_Std",// 2

            // BH BDU HEAVY STANDARD SHOULDER
            "22nd_Base_Heavy_Gray_CBRN_Low_Std",// 1
            "22nd_Base_Heavy_Gray_CBRN_High_Std",// 2
...
#include "infantrybaseXtdGear.hpp"
...
class CfgVehicles 
{
    ...
    // BH BDU LIGHT STANDARD

    //1
    class 22nd_Base_Light_Gray_CBRN_Low_Std : 22nd_Armourbase_Vehicle 
    {
        scope = 2; // Visible in editor
        author = "Warhound Mod Team";
        uniformClass = "22nd_Base_Light_Gray_CBRN_Low_Std"; // Custom uniform class
        hiddenSelections[] = {"Camo1","Camo2","Camo3","Camo4","Camo5","Camo6","Camo7","Camo8","Camo9","Camo10","Uni_Collar","Shoulders_Lower1","Shoulders_Lower2","Shoulders_Upper"};

        hiddenSelectionsTextures[] = 
        {
            "\z\22ndRDF\addons\uniforms\Armour\InfantryBase\Base\22nd_Light_BDU_BH.paa", // Upper texture  
            "MA_Armor\data\Uniforms\Marine\data\Color_Variants\MA_Gray_TrooperLowerBDU_CO.paa", // Lower texture  
            "MA_Armor\data\Uniforms\Marine\data\Color_Variants\MA_Gray_TrooperCollar_CO.paa", // Collar texture
            "MA_Armor\data\Uniforms\Marine\data\Color_Variants\TrooperSoftpadding_CO.paa", // Soft padding texture
            "MA_Armor\data\Uniforms\Marine\data\Color_Variants\TrooperArmorStraps_CO.paa", // Armor straps texture
            "\z\22ndRDF\addons\uniforms\Armour\InfantryBase\Base\22nd_BH_UpperArmour.paa", // Upper armor texture
            "\z\22ndRDF\addons\uniforms\Armour\InfantryBase\Base\22nd_BH_LowerArmour.paa", // Lower armor texture
            "\z\22ndRDF\addons\uniforms\Armour\InfantryBase\Base\22nd_Shoulders_STD_CBRN.paa", // Shoulders texture
            "\z\22ndRDF\addons\uniforms\Armour\InfantryBase\Base\22nd_Shoulders_STD_CBRN.paa", // Shoulders texture (duplicate) 
            "\z\22ndRDF\addons\uniforms\Armour\InfantryBase\Base\22nd_Shoulders_STD_CBRN.paa"  // Shoulders texture (duplicate)
        };
    };

    // 2
    class 22nd_Base_Light_Gray_CBRN_High_Std : 22nd_Armourbase_Vehicle 
    {
        scope = 2; // Visible in editor
        author = "Warhound Mod Team";
        uniformClass = "22nd_Base_Light_Gray_CBRN_High_Std"; // Custom uniform class
        hiddenSelections[] = {"Camo1","Camo2","Camo3","Camo4","Camo5","Camo6","Camo7","Camo8","Camo9","Camo10","Shoulders_Lower1","Shoulders_Lower2","Shoulders_Upper"};
    ...
    // BH BDU MEDIUM STANDARD

    // 1
    class 22nd_Base_Medium_Gray_CBRN_Low_Std : 22nd_Armourbase_Vehicle 
    {
        scope = 2; // Visible in editor
        author = "Warhound Mod Team";
        uniformClass = "22nd_Base_Medium_Gray_CBRN_Low_Std"; // Custom uniform class
        hiddenSelections[] = {"Camo1","Camo2","Camo3","Camo4","Camo5","Camo6","Camo7","Camo8","Camo9","Camo10","Uni_Collar","Shoulders_Lower1"};
    ...
    // 2
    class 22nd_Base_Medium_Gray_CBRN_High_Std : 22nd_Armourbase_Vehicle 
    {
        scope = 2; // Visible in editor
        author = "Warhound Mod Team";
        uniformClass = "22nd_Base_Medium_Gray_CBRN_High_Std"; // Custom uniform class
        hiddenSelections[] = {"Camo1","Camo2","Camo3","Camo4","Camo5","Camo6","Camo7","Camo8","Camo9","Camo10","Shoulders_Lower1"};
    ...
    // BH BDU HEAVY STANDARD

    // 1
    class 22nd_Base_Heavy_Gray_CBRN_Low_Std : 22nd_Armourbase_Vehicle 
    {
        scope = 2; // Visible in editor
        author = "Warhound Mod Team";
        uniformClass = "22nd_Base_Heavy_Gray_CBRN_Low_Std"; // Custom uniform class
        hiddenSelections[] = {"Camo1","Camo2","Camo3","Camo4","Camo5","Camo6","Camo7","Camo8","Camo9","Camo10","Uni_Collar","Shoulders_Lower2"};
    ...
    // 2
    class 22nd_Base_Heavy_Gray_CBRN_High_Std : 22nd_Armourbase_Vehicle 
    {
        scope = 2; // Visible in editor
        author = "Warhound Mod Team";
        uniformClass = "22nd_Base_Heavy_Gray_CBRN_High_Std"; // Custom uniform class
        hiddenSelections[] = {"Camo1","Camo2","Camo3","Camo4","Camo5","Camo6","Camo7","Camo8","Camo9","Camo10","Shoulders_Lower2"};
...
class CfgWeapons 
{
    ...
    class 22nd_ArmourBase : U_B_CombatUniform_mcam
    {
        ...
        picture = "\MA_Armor\data\Icons\H3_ODST_Uniform.paa"; // Path to icon 
    ...
    // 1
     class 22nd_Base_Light_Gray_CBRN_Low_Std : 22nd_ArmourBase
    {
        scope = 2;  // Visible in editor
        scopeArsenal = 2;
        displayName = "[22nd] M52A + ARMY BDU";
        ...
        class ItemInfo : ItemInfo
        {
            uniformClass = "22nd_Base_Light_Gray_CBRN_Low_Std"; // Reference to the uniform class in CfgVehicles
        };
    };


    // 2
    class 22nd_Base_Light_Gray_CBRN_High_Std : 22nd_ArmourBase
    {
        scope = 2;  // Visible in editor
        scopeArsenal = 2;
        displayName = "[22nd] M52A + ARMY BDU";
        ...
        class ItemInfo : ItemInfo
        {
            uniformClass = "22nd_Base_Light_Gray_CBRN_High_Std"; // Reference to the uniform class in CfgVehicles
        };
    };
    ...
    // 1
     class 22nd_Base_Medium_Gray_CBRN_Low_Std : 22nd_ArmourBase
    {
        scope = 2;  // Visible in editor
        scopeArsenal = 2;
        displayName = "[22nd] M52A + ARMY BDU";
        ...
        class ItemInfo : ItemInfo
        {
            uniformClass = "22nd_Base_Medium_Gray_CBRN_Low_Std"; // Reference to the uniform class in CfgVehicles
        };
    };

    // 2
    class 22nd_Base_Medium_Gray_CBRN_High_Std : 22nd_ArmourBase
    {
        scope = 2;  // Visible in editor
        scopeArsenal = 2;
        displayName = "[22nd] M52A + ARMY BDU";
        ...
        class ItemInfo : ItemInfo
        {
            uniformClass = "22nd_Base_Medium_Gray_CBRN_High_Std"; // Reference to the uniform class in CfgVehicles
        };
    };
    ...
    // 1
     class 22nd_Base_Heavy_Gray_CBRN_Low_Std : 22nd_ArmourBase
    {
        scope = 2;  // Visible in editor
        scopeArsenal = 2;
        displayName = "[22nd] M52A + ARMY BDU";
        ...
        class ItemInfo : ItemInfo
        {
            uniformClass = "22nd_Base_Heavy_Gray_CBRN_Low_Std"; // Reference to the uniform class in CfgVehicles
        };
    };

    // 2
    class 22nd_Base_Heavy_Gray_CBRN_High_Std : 22nd_ArmourBase
    {
        scope = 2;  // Visible in editor
        scopeArsenal = 2;
        displayName = "[22nd] M52A + ARMY BDU";
        ...
        class ItemInfo : ItemInfo
        {
            uniformClass = "22nd_Base_Heavy_Gray_CBRN_High_Std"; // Reference to the uniform class in CfgVehicles
        };
    };
};
