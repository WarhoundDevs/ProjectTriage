    ...
    class 22nd_Relic_HelmBase_Open: 
    {
        scope = 2;
        scopeArsenal = 2;
    ...
    class 22nd_Relic_HelmBase_Closed : 
    {
        scope = 2;
        scopeArsenal = 2;
        displayName = "[22nd] Relic's ECH252-C";
    ...
    class 22nd_Relic_HelmBase_Visor : 
    {
        scope = 2;
        scopeArsenal = 2;
    ...
    class 22nd_Relic_HelmSnow_Open : 
    {
        scope = 2;
        scopeArsenal = 2; 
    ...
    class 22nd_Relic_HelmSnow_Closed : 
    {
        scope = 2;
        scopeArsenal = 2;
    ...
    class 22nd_Relic_HelmSnow_Visor : 
    {
        scope = 2;
        scopeArsenal = 2;
