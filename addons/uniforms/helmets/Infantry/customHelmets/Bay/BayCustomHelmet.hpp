    ...
    class 22nd_Bay_HelmBase_Closed : 
    {
        scope = 2;
        scopeArsenal = 2;
        displayName = "[22nd] Bay's ECH252-C";
    ...
    class 22nd_Bay_HelmSnow_Closed : 
    {
        scope = 2;
        scopeArsenal = 2;
