    ...
    class 22nd_Sue_HelmBase_Closed : 
    {
        scope = 2;
        scopeArsenal = 2;
        displayName = "[22nd] Sue's ECH252-C";
    ...
    class 22nd_Sue_HelmSnow_Closed : 
    {
        scope = 2;
        scopeArsenal = 2;
