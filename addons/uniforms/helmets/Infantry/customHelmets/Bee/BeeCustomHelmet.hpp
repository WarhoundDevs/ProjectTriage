    ...
    class 22nd_Bee_HelmBase_Closed : 
    {
        scope = 2;
        scopeArsenal = 2;
        displayName = "[22nd] Bee's ECH252-C";
    ...
    class 22nd_Bee_HelmSnow_Closed : 
    {
        scope = 2;
        scopeArsenal = 2;
