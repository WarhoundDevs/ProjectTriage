class CfgPatches 
{
    class 22nd_uniforms_helmets_JFO
    {
        units[] = {};
        weapons[] = 
        {
...
class CfgWeapons
{
    ...
    class 22nd_JFO_WDL : 22nd_JFO_base{
        ...
        {
            "z\22ndRDF\addons\uniforms\helmets\JFO\data\base\22nd_Woodland_JFO_Helmet_CO.paa",
    ...
    class 22nd_JFO_WNT : 22nd_JFO_base{
        ...
        hiddenSelectionsTextures[]=
        {
            "z\22ndRDF\addons\uniforms\helmets\JFO\data\base\22nd_Winter_JFO_Helmet_CO.paa",
            "MA_Armor\data\Helmets\JFO\Visors\Base_JFO_Visor_CO.paa"
        };
    };
