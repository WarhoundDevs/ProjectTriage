class CfgPatches 
{
    class 22nd_uniforms_helmets_Grenadier
    {
        units[] = {};
        weapons[] = 
        {
...
class CfgWeapons
{
    ...
    //Grenadier Base
    class 22nd_Grenadier_WDL : 22nd_Grenadier_base{
        scope=0;
        scopeArsenal=0;
        author= "Astro";
        ...
        {
            "z\22ndRDF\addons\uniforms\helmets\Grenadier\data\base\22nd_Woodland_Grenadier_Helm_CO.paa",
    ...
    class 22nd_Grenadier_WNT : 22nd_Grenadier_base{
        scope=0;
        scopeArsenal=0;
        author= "Astro";
        ...
        hiddenSelectionsTextures[]=
        {
            "z\22ndRDF\addons\uniforms\helmets\Grenadier\data\base\22nd_Winter_Grenadier_Helm_CO.paa",
            "MA_Armor\data\Helmets\Grenadier\Visors\Base_Grenadier_Visor_CO.paa"
        };
    };
