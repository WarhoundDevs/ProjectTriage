...
class CfgVehicles
{
	...
	class WH_AI_Radio: OPTRE_ANPRC_521_Green
	{
		...
		model="22nd_Uniform\22nd_Bags\data\WH_Invis_Tas.p3d";
		maximumLoad=250;
	...
	class WH_Rucksack_Soft: OPTRE_UNSC_Rucksack
	{
		...
		hiddenSelectionsTextures[]=
		{
			"22nd_Uniform\22nd_Bags\data\Soft_Backpack_WH_co.paa"
		};
	};
	class WH_Rucksack_Soft_Medical: OPTRE_UNSC_Rucksack_Medic
	{
		...
		hiddenSelectionsTextures[]=
		{
			"22nd_Uniform\22nd_Bags\data\Soft_Backpack_WH_Medical_co.paa"
		};
	};
	...
	class WH_Rucksack_Soft_Snow: OPTRE_UNSC_Rucksack
	{
		...
		hiddenSelectionsTextures[]=
		{
			"22nd_Uniform\22nd_Bags\data\Soft_Backpack_WH_Sno22nd_co.paa"
		};
	};
	class WH_Rucksack_Soft_Medical_Snow: OPTRE_UNSC_Rucksack_Medic
	{
		...
		hiddenSelectionsTextures[]=
		{
			"22nd_Uniform\22nd_Bags\data\Soft_Backpack_WH_Medical_Sno22nd_co.paa"
		};
	};
	...
	class WH_Rucksack_Soft_WDL: OPTRE_UNSC_Rucksack
	{
		...
		hiddenSelectionsTextures[]=
		{
			"22nd_Uniform\22nd_Bags\data\Soft_Backpack_WH_WDL_co.paa"
		};
	};
	class WH_Rucksack_Soft_Medical_WDL: OPTRE_UNSC_Rucksack_Medic
	{
		...
		hiddenSelectionsTextures[]=
		{
			"22nd_Uniform\22nd_Bags\data\Soft_Backpack_WH_Medical_WDL_co.paa"
		};
	};
