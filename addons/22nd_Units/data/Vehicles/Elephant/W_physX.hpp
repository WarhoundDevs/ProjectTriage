/// PhysX part
simulation			= tankX;
enginePower			= 4500 * 1.2;
maxOmega 			= 1570 * 0.4652;
peakTorque 			= 9664;
torqueCurve[] 		= {
	{0, 0},
	{(1600/6000), (2650/2850)},
...
clutchStrength 		= 260.0;
fuelCapacity		= 1885;
brakeIdleSpeed		= 1.78; 	/// speed in m/s below which braking is applied
latency 			= 0.1;
tankTurnForce		= 2255000; /// Random magic number, expected to be something like 11 x mass of vehicle
...
class Wheels {
	class L2 {
		...
		sprungMass = 25625;
		springStrength = 1281250;
		springDamperRate = 362392.225;
		dampingRate = 1.0;
		dampingRateInAir = 8830.0;
		dampingRateDamaged = 10.0;
		dampingRateDestroyed = 10000.0;
		maxDroop = 0.1;			//maxDroop = 0.15;
		maxCompression = 0.1;		//maxCompression = 0.15;
	};
	class L3: L2 {
